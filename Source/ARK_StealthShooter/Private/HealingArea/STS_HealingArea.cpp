...
#include "HealingArea/STS_HealingArea.h"
...
{
	ASTS_BaseCharacter* OverlappinCharacter = Cast<ASTS_BaseCharacter>(OtherActor);
	if (OverlappinCharacter)
	{
		Heal(OverlappinCharacter);
	}
}
